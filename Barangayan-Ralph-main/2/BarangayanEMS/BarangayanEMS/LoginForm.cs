...
namespace BarangayanEMS
{
    public partial class LoginForm : Form
    {
        ...
        private void BtnSignIn_Click(object sender, EventArgs e)
        {
            ...
            string pass = GetActualText(txtPassword, PlaceholderPassword);
            ...
            if (_userRepository.TryAuthenticate(email, pass, out UserRecord user))
            {
                ...
                DashboardForm dashboard = new DashboardForm(displayName);
                dashboard.Show();
                Hide();
            }
            else
